...
namespace Json.Comparer
{
    public class JTokenComparer
    {
        ...
        public JTokenComparer(IArrayKeySelector arrayKeySelector, IEnumerable<IComparisonFilter> filters, IEnumerable<ComparisonResult> filteredMissingComparisonResults, IValueConverter valueConverter)
        {
            this.filteredMissingComparisonResults = filteredMissingComparisonResults;
        ...
        /// <summary>
        /// Get the comparisonResult from the collection. returns equal if all elements are present and equal. returns difference if any element is missing or different.
        /// </summary>
